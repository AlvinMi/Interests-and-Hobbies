...
//	SPI_Write_Byte(WRITE_REG_CMD + EN_RXADDR, 0x00); 
	...
	SPI_Write_Byte(WRITE_REG_CMD + RF_CH, 60);        						//设置通道通信频率，工作通道频率可由以下公式计算得出：Fo=（2400+RF-CH）MHz.并且射频收发器工作的频率范围从2.400-2.525GHz
